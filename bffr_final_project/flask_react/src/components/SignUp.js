...
function SignUp() {
  ...
  let names = ['Nicki Minaj', 'Taylor Swift', 'Childish Gambino', 'Drake', 'Brent Faiyaz', 'Harry Styles', 'Steve Lacey', 'Ur Mom', 'Hasbulla']
      ...
      <div class="mainContainer" >
        ...
        <div class="signUpContainer"> 
          ...
          <h2 class = "numberTxt"> Name </h2>
            ...
            <input class = "phoneInput" type="text" name="name" placeholder={phName}
            maxlength="50" onChange={evt => updateName(evt)}/>
            { (statusMessage2 != "none") === true ? (<p class = "statusMessage"> {statusMessage2} </p>) : null }


            <h2 class = "numberTxt"> Phone Number </h2>

            <input class = "phoneInput" type="tel" name="num" placeholder="000-000-0000"
            ...
            <button class = "submitButton" type="submit" onClick={routeChange} value="Log In -->"> Sign Up --> </button>
